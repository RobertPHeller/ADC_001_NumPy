...
//-------------------------------------------------------------------
uint8_t pru0_init(const char *pru_execpath) {
  ...
  snprintf(pathbuffer,sizeof(pathbuffer),"%s/text0.bin",pru_execpath);
  //retval = prussdrv_exec_program (PRU0, "./text0.bin");
  retval = prussdrv_exec_program (PRU0, pathbuffer);  
  if (retval != 0) {
...
//-------------------------------------------------------------------
uint8_t pru1_init(const char *pru_execpath) {
  ...
  snprintf(pathbuffer,sizeof(pathbuffer),"%s/text1.bin",pru_execpath);  
  //retval = prussdrv_exec_program (PRU1, "./text1.bin");
  retval = prussdrv_exec_program (PRU1, pathbuffer);  
  if (retval != 0) {
